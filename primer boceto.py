...
class Pajaro:
    ...
    def dibujar(self, superficie):
        # Sin rotación: se dibuja directo sobre la pantalla, siempre "derecho"
        ...
        pygame.draw.ellipse(superficie, NARANJA,
                             (self.x - 4, self.y - 2, 16, 10))
        pygame.draw.circle(superficie, NEGRO, (self.x + 6, self.y - 6), 3)
        pygame.draw.polygon(superficie, NARANJA, [
            (self.x + self.radio - 4, self.y - 2),
            (self.x + self.radio + 6, self.y + 2),
            (self.x + self.radio - 4, self.y + 6),
        ])
